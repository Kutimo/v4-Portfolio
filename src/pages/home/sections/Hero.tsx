  ...
  return (
    <section className="flex h-screen mx-5 mt-10 md:mx-10">
      <div className="w-full">
        <h3 className="font-sans text-lg text-white">Hello, i am</h3>
        ...
        <div className="flex flex-col items-start p-2 text-light-shade-200 w-fit">
          <p className="w-3/4 mt-10 text-xl md:w-96">
          ...
          <a
            href="#projects"
            className="p-3 mt-10 text-xl font-medium transition-all duration-300 ease-in border-2 border-white rounded-md shadow-md text-light-shade-100 hover:bg-light-shade-400 hover:border-light-shade-200 hover:text-black hover:rounded-none">
            View portfolio
          </a>
        </div>
      </div>
